        $(document).ready(function(){
            ...
            $('#topup').click(function(){
               ...
               var topupUser = $('#users').val();
                ...
                $.ajax({
					...
					success: function (returnData){
					swal("Successfull topup!", "" + topupUser + " GOT " + topupAmount + " CREDITS" , "success")
                        $('#users').val('');
                        $('#amount').val('');
                        $('#main_panel').html(returnData);
            ...
            $('#users').keyup(function(){              
               ...
               error: function() {
                   sweetAlert("Oops...", "Something went wrong while getting users", "error");
       ...
       function thisFunction(e)
        ...
        function userApprove(e) 
        {
           ...
           $.ajax({
               ...
               success : function(response) {
					swal("Account approved!", "The user account has been approved!" , "success")
                    $('#main_panel').html(response);
                },
               error: function() {
                   alert("SOMETHING WENT WRONG");
